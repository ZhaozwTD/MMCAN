...
def parse_args():
    ...
    parser.add_argument('--mode', default='train', type=str, choices=['train', 'test'],
                        help='mode')
    # encoder config
    parser.add_argument('--train_text', default='./twitter_data/train_posts.txt', type=str,
                        help='train text file')
    parser.add_argument('--train_image', default='./twitter_data/images', type=str,
                        help='train image folder')
    parser.add_argument('--test_text', default='./twitter_data/test_posts.txt', type=str,
                        help='test text file')
    parser.add_argument('--test_image', default='./twitter_data/images', type=str,
                        help='test image folder')

    parser.add_argument('--data_file', default='./twitter_data/twitter_data_embedding.pkl', type=str,
