...
class DataIterater(object):
    def __init__(self, datas, config):
        ...
        self.bert_model = transformers.BertModel.from_pretrained('chinese-roberta-wwm-ext')
        self.tokenizer = transformers.BertTokenizer.from_pretrained('chinese-roberta-wwm-ext')
